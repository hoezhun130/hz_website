...
![light mode only](/assets/CTF/SKR_CTF/challenge.png){: .light .w-75 .shadow .rounded-10 w='1212' h='668' }
![dark mode only](/assets/CTF/SKR_CTF/challenge.png){: .dark .w-75 .shadow .rounded-10 w='1212' h='668' }
