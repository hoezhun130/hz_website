...
tags: "RE TI Cryptography Web OSINT olevba rhysida pizzini DirectoryTraversal LFI PHPwrapper GoogleDorking Instagram metadata Base32 RenderImage jdvrif AudioStego Wi-FiPassword Mobile RawData P-Decode PacketTracer BruteForce"
...
![light mode only](/assets/CTF/rENTAS_CTF/Network/pkt.png){: .light .w-75 .shadow .rounded-10 w='1212' h='668' }
![dark mode only](/assets/CTF/rENTAS_CTF/Network/pkt.png){: .dark .w-75 .shadow .rounded-10 w='1212' h='668' }
...
![light mode only](/assets/CTF/rENTAS_CTF/Network/services.png){: .light .w-75 .shadow .rounded-10 w='1212' h='668' }
![dark mode only](/assets/CTF/rENTAS_CTF/Network/services.png){: .dark .w-75 .shadow .rounded-10 w='1212' h='668' }

We found the flag within the HTML content.

![light mode only](/assets/CTF/rENTAS_CTF/Network/html_flag.png){: .light .w-75 .shadow .rounded-10 w='1212' h='668' }
![dark mode only](/assets/CTF/rENTAS_CTF/Network/html_flag.png){: .dark .w-75 .shadow .rounded-10 w='1212' h='668' }
...
We used BurpSuite to capture the request during a login attempt. As the challenge provided with a password wordlist, we decided to bruce force the password. We sent the request to intruder and ensure the username is `admin`. Besides, we marked the value of the password parameter as a variable for the payload.

![light mode only](/assets/CTF/rENTAS_CTF/Web/request.png){: .light .w-75 .shadow .rounded-10 w='1212' h='668' }
![dark mode only](/assets/CTF/rENTAS_CTF/Web/request.png){: .dark .w-75 .shadow .rounded-10 w='1212' h='668' }

We navigated to the payload tab and paste the password list inside the payload settings.

![light mode only](/assets/CTF/rENTAS_CTF/Web/password.png){: .light .w-75 .shadow .rounded-10 w='1212' h='668' }
![dark mode only](/assets/CTF/rENTAS_CTF/Web/password.png){: .dark .w-75 .shadow .rounded-10 w='1212' h='668' }

We added `Invalid` as a keyword in the Grep-Match function to ensure that unsuccessful login attempts could be filtered out.

![light mode only](/assets/CTF/rENTAS_CTF/Web/filter.png){: .light .w-75 .shadow .rounded-10 w='1212' h='668' }
![dark mode only](/assets/CTF/rENTAS_CTF/Web/filter.png){: .dark .w-75 .shadow .rounded-10 w='1212' h='668' }

Next, we can start the brute force attack. After the bruce force completed, we can filter the results by the `Invalid` keyword and the length from the smallest to the largest to identify the response where the login was successful.

![light mode only](/assets/CTF/rENTAS_CTF/Web/bruteforce.png){: .light .w-75 .shadow .rounded-10 w='1212' h='668' }
![dark mode only](/assets/CTF/rENTAS_CTF/Web/bruteforce.png){: .dark .w-75 .shadow .rounded-10 w='1212' h='668' }

We found the successful login response where the password was `secretpass`. The flag was included in the response body of the successful login.

![light mode only](/assets/CTF/rENTAS_CTF/Web/response.png){: .light .w-75 .shadow .rounded-10 w='1212' h='668' }
![dark mode only](/assets/CTF/rENTAS_CTF/Web/response.png){: .dark .w-75 .shadow .rounded-10 w='1212' h='668' }

**Flag:**
`RWSC{n0_brut3f0rc3_pl34s3}`